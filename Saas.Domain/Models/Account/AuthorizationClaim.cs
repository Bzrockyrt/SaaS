...
namespace SaaS.Domain.Models.Account
{
    ...
    {
        /// <summary>
        /// Gets or sets the identifier for this authorization claim.
        /// </summary>
        public virtual int Id { get; set; } = default!;

        /// <summary>
        /// Gets or sets the of the primary key of the authorization associated with this claim.
        /// </summary>
        public virtual int AuthorizationId { get; set; } = default!;
