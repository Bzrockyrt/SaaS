        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Company_CompanyPicture_PictureId",
                        column: x => x.PictureId,
                        principalTable: "CompanyPicture",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });

            migrationBuilder.CreateTable(
                name: "ApplicationRoleFunctionnality",
                columns: table => new
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    RoleId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    FunctionnalityId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedBy = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    UpdatedOn = table.Column<DateTime>(type: "datetime2", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApplicationRoleFunctionnality", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ApplicationRoleFunctionnality_AspNetRoles_RoleId",
                        column: x => x.RoleId,
                        principalTable: "AspNetRoles",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ApplicationRoleFunctionnality_Functionnality_FunctionnalityId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CompanyFunctionnalities_Company_CompanyId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CompanyId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    WorkSiteTypeId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedBy = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    UpdatedOn = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApplicationRoleFunctionnality_FunctionnalityId",
                table: "ApplicationRoleFunctionnality",
                column: "FunctionnalityId");

            migrationBuilder.CreateIndex(
                name: "IX_ApplicationRoleFunctionnality_RoleId",
                table: "ApplicationRoleFunctionnality",
                column: "RoleId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CompanyFunctionnalities_CompanyId",
